...
configurations = pd.DataFrame(columns=['outer_width', 'inner_width', 'outer_height', 'inner_height', 'mass', 'deflection', 'rotation', 'Iy', 'Ix', 'A', 'm', 'j', 'sigma_y', 'embodied_energy', 'material'])
...
configurations['composite_score'] = (weight_mass * configurations['norm_mass'] +
                                     ...
                                     weight_embody * configurations['norm_embody'])

configurations.to_csv('configurations.csv', index=False)

# Find the optimal configuration
sorted_data = configurations.sort_values('composite_score', ascending=True)
