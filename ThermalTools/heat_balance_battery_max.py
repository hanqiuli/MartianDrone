...
heat_balance_cold = {
    ...
    'area_top': 0.189*0.168,  # [m^2] - Top surface area of the battery
    ...
    # battery properties
    'heat_rate_internal': {'electronics': 20},  # [W] - Heat from internal sources

    'coefficient_convection': 1,  # [W/m^2*K] - Convection coefficient
    'area_total': (0.14*0.168*2+2*0.189*0.168+2*0.14*0.189),  # [m^2] - Total surface area of the battery
    'f_re': 1,  # [-] - View factor for emitted radiation
    'emissivity_battery': 0.01,  # [-] - Emissivity of the battery
    'battery_mass': 9.112,  # [kg] - Mass of the battery
...
heat_balance_hot = {
    ...
    'irradiance_sun': 649,  # [W/m^2] - Solar irradiance
    'absorptivity': 0.2,  # [-] - Absorptance of the battery
    'f_sr': 1,  # [-] - View factor for solar radiation
    'area_top': 0.189*0.168,  # [m^2] - Top surface area of the battery
    ...
    'stefan_boltzmann_constant': 5.6704e-8,  # [W/m^2*K^4] - Stefan-Boltzmann constant
        ...
        # battery properties
    'heat_rate_internal': {'heater': 0},  # [W] - Heat from internal sources

    'coefficient_convection': 1,  # [W/m^2*K] - Convection coefficient
    'area_total': (0.14*0.168*2+2*0.189*0.168+2*0.14*0.189),  # [m^2] - Total surface area of the battery
    'f_re': 1,  # [-] - View factor for emitted radiation
    'emissivity_battery': 0.4,  # [-] - Emissivity of the battery
    'battery_mass': 9.112,  # [kg] - Mass of the battery
...
class BatteryHeatTransfer:
    ...
    def solve_temperature_time(self):
        ...
        """
        t = np.arange(0, 12*60*60, 10)
        temperature = odeint(self.temperature_time_derivative, y0=self.temperature_atmosphere, t=t)
