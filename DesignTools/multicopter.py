...
def calculate_rotor_group_mass(A_blade, T_max, r_rotor, N_rotor):
    ...
    return calculate_blade_mass(A_blade, N_rotor) + calculate_hub_mass(T_max, N_rotor) + \
            calculate_shaft_mass(r_rotor, N_rotor) + calculate_support_mass(r_rotor, N_rotor)
